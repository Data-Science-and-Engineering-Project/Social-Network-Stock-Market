"""
Configuration module for step1_russell3000_filtering pipeline.
...
for env_path in [
    ...
    Path(__file__).parent / '.env',  # step1_russell3000_filtering
...
DEFAULT_LOG_FILE = os.getenv("PIPELINE_LOG_FILE", "step1_russell3000_filtering/pipeline_log.txt")
